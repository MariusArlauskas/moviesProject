...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/movies' => [
            [['_route' => 'movies_apimovies_get', '_controller' => 'App\\Controller\\EntityController\\MoviesController::getMovies'], null, ['GET' => 0], null, false, false, null],
    ...
    [ // $dynamicRoutes
        ...
        64 => [[['_route' => 'movies_apimovie_get', '_controller' => 'App\\Controller\\EntityController\\MoviesController::getMovie'], ['movieName'], ['GET' => 0], null, false, true, null]],
        84 => [
