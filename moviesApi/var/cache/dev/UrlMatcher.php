...
return [
    ...
    [ // $dynamicRoutes
        ...
        81 => [[['_route' => 'movies_apimovies_get', '_controller' => 'App\\Controller\\EntityController\\MoviesController::getMovies'], ['pageNumber', 'userId'], ['GET' => 0], null, false, true, null]],
        93 => [[['_route' => 'movies_apimovie_show_one', '_controller' => 'App\\Controller\\EntityController\\MoviesController::getOneFromDbAction'], ['id'], ['GET' => 0], null, false, true, null]],
        115 => [[['_route' => 'user_show_one', '_controller' => 'App\\Controller\\EntityController\\UserController::getOneAction'], ['id'], ['GET' => 0], null, false, true, null]],
        160 => [[['_route' => 'user_add_movie', '_controller' => 'App\\Controller\\EntityController\\UserController::addMovieStatus'], ['userId', 'apiId', 'movieId', 'relationType'], ['POST' => 0], null, false, true, null]],
        185 => [[['_route' => 'user_profile_data', '_controller' => 'App\\Controller\\ProfileController::getAction'], ['id'], ['GET' => 0], null, false, true, null]],
        200 => [
